...
public class Util2Hospital2 {
	...
	private static ArrayList<String> create_subject(Model2Caramel model){
		...
		String subject_reason [] = {
				...
				CaramelWriterProperties.TAG_P_START+"건강을위해서 꼭 가야하는 곳~!"+keyword +" "+ businessName + ", 이곳이 왜 유명한지 전격 해부했습니다. "+CaramelWriterProperties.TAG_P_END,
				CaramelWriterProperties.TAG_P_START+"건강을위해서 꼭 가야하는 곳~!"+keyword +" "+ businessName + ", 이곳은 많은사람들이 추천하는곳이예요^^ "+CaramelWriterProperties.TAG_P_END,
				CaramelWriterProperties.TAG_P_START+"건강을위해서 꼭 가야하는 곳~!"+keyword +" "+ businessName + ", 이곳은 사람들이 많이 추천하는 곳이랍니다~ "+CaramelWriterProperties.TAG_P_END,
				CaramelWriterProperties.TAG_P_START+"건강을위해서 꼭 가야하는 곳~!"+keyword +" "+ businessName + ", 이곳이 바로 사람들이 그렇게도 추천하는 곳이랍니다. "+CaramelWriterProperties.TAG_P_END,
				CaramelWriterProperties.TAG_P_START+"건강을위해서 꼭 가야하는 곳~!"+keyword +" "+ businessName + ", 이곳에서 고민상담 받아보시는게 어떠세요? "+CaramelWriterProperties.TAG_P_END,
		};
		...
		String subject_place [] = {
				CaramelWriterProperties.TAG_P_START+"잘하기로 소문난 "+keyword +" "+ businessName + ", 어떻게 이벤트에 응보할수있을까요?"+CaramelWriterProperties.TAG_P_END,
				CaramelWriterProperties.TAG_P_START+"최고의 실력을 가진 "+keyword +" "+ businessName + ", 어떻게 더 자세한 내용을 착아볼수있을까요?"+CaramelWriterProperties.TAG_P_END,
